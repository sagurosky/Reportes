...
public class Convertidor {
    ...
    public static String deCamelCase(String camelCase) {
        ...
        // si necesito que el primer caracter sea mayuscula reemplazar por la siguiente
        // linea
        // StringBuilder result = new StringBuilder(camelCase.substring(0,
        // 1).toUpperCase());
        ...
        for (int i = 1; i < camelCase.length(); i++) {
            ...
            // Si el carácter actual es mayúscula, añadir un espacio y convertirlo a
            // minúscula
